  ...
  routes: [
    ...
    children: [
      ...
      },
      {
        name: "registro",
        path: "registro",
        component: () => import("@/views/usuarios/registrar"),
      },
    ]},
      ...
      children: [
        ...
        },
        {
         ...
         // MAQUILA
         {
          ...
          path: "produccion/partesDiariosProduccion",
        ...
        {
          name: "Pagos",
          path: "servicios/transporte/pagos",
          component: () => import("@/views/servicios/transportes/pagos"),
        },
        {
          name: "Pagosad",
          ...
          
        {
          ...
          component: () => import("@/views/ingresos/zonas"),
        },
        {
          name: "Variedades",
          path: "mantenimiento/variedades",
          component: () =>
            import("@/views/ingresos/variedades"),
        },
        {
          name: "Molinos",
          path: "mantenimiento/molinos",
          component: () => import("@/views/servicios/maquila/molinos"),
        },
        {
          name: "Vasijas",
          path: "mantenimiento/vasijas",
          component: () => import("@/views/servicios/maquila/vasijas"),
        },
        {
          name: "Productos",
          path: "mantenimiento/productos",
          component: () => import("@/views/servicios/maquila/productos"),
        },
        {
          name: "Vehiculos",
          path: "mantenimiento/vehiculos",
          component: () => import("@/views/servicios/transportes/vehiculos"),
        },
        ...
        },
        {
          name: "Productores",
          path: "productores:id",
          component: () => import("@/views/usuarios/perfiles"),
        },
        {
          name: "Productores",
          path: "productores",
          component: () => import("@/views/productores/productores"),
        },
        {
          name: "Productos",
          path: "productos",
          component: () => import("@/views/productos/productos"),
        },
        // FIN DE APLICACIÓNN
