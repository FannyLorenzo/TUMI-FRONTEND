...
.grid-base(@widgetName) {
    ...
    @MATERIAL_GRID_BASE_BORDER_COLOR: ~"@{@{widgetName}-border-color}";
    @MATERIAL_GRID_BASE_DRAG_HEADER_FIRST_SHADOW: 0 0 1px ~"@{@{widgetName}-drag-header-shadow-color}";
    @MATERIAL_GRID_BASE_DRAG_HEADER_SECOND_SHADOW: 0 1px 3px ~"@{@{widgetName}-drag-header-second-shadow-color}";
    ...
    .dx-set-checkbox-border-color-as-background() when (@MATERIAL_COLOR_POSTFIX = ".contrast") {
        .dx-selection .dx-checkbox-icon {
            border-color: ~"@{@{widgetName}-base-background-color}";
        }
    }
    ...
    .dx-@{widgetName}-container {
        ...
        .dx-menu-item-has-icon {
            .dx-icon {
                color: ~"@{@{widgetName}-menu-icon-color}";
            }
        }
        ...
        .dx-header-filter:not(.dx-header-filter-empty) {
            color: ~"@{@{widgetName}-active-header-filter-icon-color}";
        }
    ...
    .dx-@{widgetName} {
        ...
        .dx-row-alt {
            & > td {
                background-color: ~"@{@{widgetName}-row-alternation-bg}";
                // T838734
                border-top: ~"1px solid @{@{widgetName}-row-alternation-bg}";
                border-bottom: ~"1px solid @{@{widgetName}-row-alternation-bg}";
            }
    ...
    .dx-editor-cell {
        ...
        .dx-texteditor {
            ...
            &.dx-state-focused,
            &.dx-state-active {
                background: ~"@{@{widgetName}-editor-bg}";
                box-shadow: none;
            }
            ...
            .dx-tag-container {
                min-height: @MATERIAL_GRID_BASE_CELL_HEIGHT;
                padding: 0;
            }
        ...
        .dx-dropdowneditor {
            background-color: ~"@{@{widgetName}-editor-bg}";
        }
    ...
    .dx-@{widgetName}-column-chooser-list {
        .dx-empty-message {
            color: ~"@{@{widgetName}-columnchooser-message-color}";
        ...
        .dx-overlay-content {
            ...
            .dx-popup-content {
                .dx-column-chooser-item {
                    ...
                    background-color: ~"@{@{widgetName}-columnchooser-item-bg}";
    ...
    .dx-@{widgetName}-drag-header {
        border-color: ~"@{@{widgetName}-drag-header-border-color}";
        box-shadow: @MATERIAL_GRID_BASE_DRAG_HEADER_FIRST_SHADOW, @MATERIAL_GRID_BASE_DRAG_HEADER_SECOND_SHADOW;
        color: ~"@{@{widgetName}-columnchooser-item-color}";
        font-weight: ~"@{@{widgetName}-columnchooser-font-weight}";
        padding: @MATERIAL_GRID_BASE_HEADER_CELL_VERTICAL_PADDING;
        background-color: ~"@{@{widgetName}-header-drag-bg}";
        line-height: @MATERIAL_GRID_BASE_HEADER_LINE_HEIGHT;
        font-size: @MATERIAL_GRID_BASE_HEADER_CELL_FONT_SIZE;
    }

    .dx-@{widgetName}-columns-separator {
        background-color: ~"@{@{widgetName}-column-separator-bg}";
    }
    ...
    .dx-@{widgetName}-drop-highlight {
        & > td {
            background-color: ~"@{@{widgetName}-drop-highlight-bg}";
            color: ~"@{@{widgetName}-drop-highlight-color}";
            ...
            .dx-checkbox {
                .dx-checkbox-icon {
                    background-color: ~"@{@{widgetName}-drop-highlight-color}";
                    color: ~"@{@{widgetName}-drop-highlight-bg}";
                }
            }
        }
    }
    ...
    .dx-@{widgetName}-focus-overlay:after {
        ...
        bottom: 0;
        height: 2px;
        background-color: ~"@{@{widgetName}-focused-border-color}";
        left: 0;
        right: 1px;
    }
    ...
    .dx-data-row.dx-state-hover {
        &:not(.dx-selection):not(.dx-row-inserted):not(.dx-row-removed):not(.dx-edit-row):not(.dx-row-focused) {
            background-color: ~"@{@{widgetName}-hover-bg}";

            > td {
                color: ~"@{@{widgetName}-row-hovered-color}";
            }
            ...
            .dx-row {
                > td {
                    ...
                    &:hover {
                        ...
                        .dx-sort {
                            color: ~"@{@{widgetName}-columnchooser-hover-icon-color}";
                        }
                    }
    ...
    .dx-@{widgetName}-filter-row {
        ...
        .dx-filter-modified {
            background-color: ~"@{@{widgetName}-cell-modified-border-color}";
        }
    ...
    .dx-@{widgetName}-rowsview {
        ...
        .dx-master-detail-row:not(.dx-@{widgetName}-edit-form) {
            > .dx-@{widgetName}-group-space,
            .dx-master-detail-cell {
                background-color: ~"@{@{widgetName}-master-detail-cell-bg}";
            }
        }
        ...
        .dx-adaptive-detail-row {
            ...
            &.dx-selection:hover {
                ...
                .dx-validator {
                    ...
                    &.dx-invalid {
                        background-color: ~"@{@{widgetName}-row-invalid-faded-border-color}";
                    }
                }
            }
        ...
        .dx-row-removed > td {
            background-color: ~"@{@{widgetName}-row-removed-bg}";
            border-top: 1px solid ~"@{@{widgetName}-cell-modified-border-color}";
            border-bottom: 1px solid ~"@{@{widgetName}-cell-modified-border-color}";
        }
        ...
        .dx-row-focused {
            ...
            &.dx-data-row {
                ...
                & .dx-command-edit .dx-link {
                    background-color: ~"@{@{widgetName}-row-focused-bg}";
                    color: ~"@{@{widgetName}-row-focused-color}";
                ...
                & > td,
                & > tr:last-child > td {
                    border-bottom: 1px solid ~"@{@{widgetName}-focused-border-color}";
                }

                &:not(.dx-row-lines) {
                    & > td,
                    & > tr:first-child > td {
                        border-top: 1px solid ~"@{@{widgetName}-focused-border-color}";
                        border-bottom: 1px solid ~"@{@{widgetName}-focused-border-color}";
                    }
                }
            }
        ...
        .dx-selection.dx-row:not(.dx-row-focused):hover {
            & > td,
            & > tr > td {
                background-color: ~"@{@{widgetName}-selection-bg}";
                color: ~"@{@{widgetName}-row-selected-color}";

                &.dx-@{widgetName}-group-space {
                    border-right-color: ~"@{@{widgetName}-selection-bg}";
                }

                &.dx-pointer-events-none {
                    border-left-color: ~"@{@{widgetName}-row-selected-border-color}";
                    border-right-color: ~"@{@{widgetName}-row-selected-border-color}";
                }
            }

            &:not(.dx-row-lines) > td {
                border-bottom: 1px solid ~"@{@{widgetName}-selection-bg}";
                border-top: 1px solid ~"@{@{widgetName}-selection-bg}";
            }

            &.dx-row-lines > td {
                border-bottom-color: ~"@{@{widgetName}-row-selected-border-color}";
            }
        }
    ...
    .dx-@{widgetName}-search-text {
        color: ~"@{@{widgetName}-search-color}";
        background-color: ~"@{@{widgetName}-search-bg}";
    }
    ...
    .dx-@{widgetName}-summary-item {
        color: ~"@{@{widgetName}-summary-color}";
    }
    ...
    .dx-rtl {
        .dx-data-row.dx-state-hover {
            &:not(.dx-selection):not(.dx-row-inserted):not(.dx-row-removed):not(.dx-edit-row):not(.dx-row-focused) {
                & > td:not(.dx-focused) {
                    &.dx-@{widgetName}-group-space {
                        border-left-color: ~"@{@{widgetName}-hover-bg}";
        ...
        .dx-@{widgetName}-rowsview {
            ...
            .dx-selection.dx-row:hover {
                ...
                & > tr > td {
                    &:not(.dx-focused) {
                        &.dx-@{widgetName}-group-space {
                            border-left-color: ~"@{@{widgetName}-selection-bg}";
                        }
                    }
    ...
    .dx-@{widgetName}-filter-panel {
        ...
        .dx-@{widgetName}-filter-panel-clear-filter {
            color: ~"@{@{widgetName}-filter-panel-color}";
            font-size: @MATERIAL_GRID_BASE_CELL_FONT_SIZE;
