...
.dx-size-default() {
    ...
    @MATERIAL_POPUP_TOOLBARTOP_PADDING_RTL: 0 24px 0 8px;
    @MATERIAL_POPUP_TOOLBARBOTTOM_PADDING: 0 8px 0 24px;
    @MATERIAL_POPUP_TOOLBARBOTTOM_PADDING_RTL: 0 24px 0 8px;
...
.dx-size-compact() {
    ...
    @MATERIAL_POPUP_TOOLBARTOP_PADDING_RTL: 0 16px 0 8px;
    @MATERIAL_POPUP_TOOLBARBOTTOM_PADDING: 0 8px 0 16px;
    @MATERIAL_POPUP_TOOLBARBOTTOM_PADDING_RTL: 0 16px 0 8px;
...
.dx-rtl {
    .dx-popup-title {
        &.dx-toolbar {
            .dx-toolbar-sizing(
                ...
                @MATERIAL_POPUP_TOOLBARTOP_PADDING_RTL,
                @MATERIAL_POPUP_TOOLBAR_LABEL_FONT_SIZE,
                @MATERIAL_POPUP_TOOLBAR_ITEM_SPACING
            );
        }
    ...
    .dx-popup-bottom {
        &.dx-toolbar {
            .dx-toolbar-sizing(
                @MATERIAL_POPUP_BOTTOM_TOOLBAR_HEIGHT,
                @MATERIAL_POPUP_TOOLBARBOTTOM_PADDING_RTL,
                @MATERIAL_POPUP_TOOLBAR_LABEL_FONT_SIZE,
                @MATERIAL_POPUP_TOOLBAR_ITEM_SPACING
            );
