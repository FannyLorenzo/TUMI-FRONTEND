...
@SCHEDULER_SMALL_SIZE_ELEMENT_OFFSET: @SCHEDULER_LEFT_COLUMN_WIDTH * @SCHEDULER_SMALL_SIZE_FACTOR;
...
.dx-scheduler-agenda-group-mixin(@offset) {
    .set-offset(@offset) {
        ...
        .dx-scheduler-scrollable-appointments {
            ...
            .dx-scheduler-small & {
                padding-left: @offset * @SCHEDULER_SMALL_SIZE_FACTOR + @SCHEDULER_SMALL_SIZE_ELEMENT_OFFSET;
            }
            ...
            .dx-rtl & {
                ...
                .dx-scheduler-small & {
                    padding-right: @offset * @SCHEDULER_SMALL_SIZE_FACTOR + @SCHEDULER_SMALL_SIZE_ELEMENT_OFFSET;
                }
            }
        }
    }
...
.scheduler-mixin(@left-column-width) {
    ...
    .dx-scheduler-work-space-day {
        ...
        .dx-scheduler-date-time-indicator {
            ...
            .dx-scheduler-small & {
                margin-left: @SCHEDULER_SMALL_SIZE_ELEMENT_OFFSET;
            }
        }
    ...
    .dx-scheduler-work-space-both-scrollbar {
        ...
        .dx-scheduler-all-day-title {
            ...
            &:before {
                ...
                .dx-scheduler-small & {
                    width: @SCHEDULER_SMALL_SIZE_ELEMENT_OFFSET;
                }
            }
        }
        ...
        .dx-scheduler-header-scrollable.dx-scrollable {
            ...
            .dx-scheduler-small & {
                margin: 0 0 0 @SCHEDULER_SMALL_SIZE_ELEMENT_OFFSET;
            }
            ...
            .dx-rtl.dx-scheduler-small & {
                margin: 0 @SCHEDULER_SMALL_SIZE_ELEMENT_OFFSET 0 0;
            }
        }
    ...
    .dx-scheduler-agenda {
        ...
        .dx-scheduler-scrollable-appointments {
            ...
            .dx-scheduler-small & {
                &.dx-rtl {
                    padding-left: 0;
                    padding-right: @SCHEDULER_SMALL_SIZE_ELEMENT_OFFSET;
                }

                padding-left: @SCHEDULER_SMALL_SIZE_ELEMENT_OFFSET;
            }
    ...
    .dx-rtl {
        ...
        .dx-scheduler-work-space:not(.dx-scheduler-timeline):not(.dx-scheduler-work-space-month):not(.dx-scheduler-work-space-vertical-grouped):not(.dx-scheduler-work-space-both-scrollbar) {
            .dx-scheduler-date-table {
                float: right;
                margin-left: 0;
                margin-right: -@SCHEDULER_LEFT_COLUMN_WIDTH;
                ...
                .dx-scheduler-small & {
                    margin-right: -@SCHEDULER_SMALL_SIZE_ELEMENT_OFFSET;
                }
            }
        }

        .dx-scheduler-appointment-recurrence-icon {
            left: @SCHEDULER_REDUCED_ICON_OFFSET;
            right: auto;
        }
        ...
        .dx-scheduler-work-space-day {
            .dx-scheduler-appointment-reduced {
                .dx-scheduler-appointment-content {
                    padding-right: 5px;
                    padding-left: @SCHEDULER_APPOINTMENT_REDUCED_CONTENT_PADDING;
                }
            }
        }
