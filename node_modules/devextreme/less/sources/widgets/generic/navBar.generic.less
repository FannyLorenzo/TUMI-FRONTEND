/**
* DevExtreme (widgets/generic/navBar.generic.less)
* Version: 19.2.12
...
.dx-size-default() {
    @GENERIC_NAVBAR_ICON_SIZE: 31px;
    @GENERIC_NAVBAR_BADGE_TOP: ~"11%";
}
.dx-size-compact() {
    @GENERIC_NAVBAR_ICON_SIZE: 26px;
    @GENERIC_NAVBAR_BADGE_TOP: ~"6%";
}
...
.dx-rtl .dx-nav-item {
    ...
    .dx-navbar & .dx-icon {
        .dx-icon-sizing(@GENERIC_NAVBAR_ICON_SIZE);
