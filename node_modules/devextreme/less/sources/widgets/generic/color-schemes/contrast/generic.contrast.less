/**
* DevExtreme (widgets/generic/color-schemes/contrast/generic.contrast.less)
* Version: 19.2.12
...
@button-special-hover: @base-accent;

@button-normal-contained-bg-hover: @base-hover-color;
@button-normal-contained-bg-focused: @base-focus-color;
@button-normal-contained-bg-active: @button-normal-bg;

@button-normal-outlined-bg-hover: @base-hover-color;
@button-normal-outlined-bg-focused: @base-focus-color;
@button-normal-outlined-bg-active: @button-normal-bg;

@button-normal-text-bg-hover: @base-hover-color;
@button-normal-text-bg-focused: @base-focus-color;
@button-normal-text-bg-active: @button-normal-bg;
...
@button-default-contained-bg-hover: @base-inverted-bg;
@button-default-contained-bg-focused: @base-inverted-bg;
@button-default-contained-bg-active: @button-default-bg;

@button-default-outlined-bg-hover: @base-inverted-bg;
@button-default-outlined-bg-focused: @base-inverted-bg;
@button-default-outlined-bg-active: @button-default-bg;

@button-default-text-bg-hover: @base-inverted-bg;
@button-default-text-bg-focused: @base-inverted-bg;
@button-default-text-bg-active: @button-default-bg;
...
@button-danger-contained-bg-hover: @base-inverted-bg;
@button-danger-contained-bg-focused: @base-inverted-bg;
@button-danger-contained-bg-active: @button-danger-bg;

@button-danger-outlined-bg-hover: @base-inverted-bg;
@button-danger-outlined-bg-focused: @base-inverted-bg;
@button-danger-outlined-bg-active: @button-danger-bg;

@button-danger-text-bg-hover: @base-inverted-bg;
@button-danger-text-bg-focused: @base-inverted-bg;
@button-danger-text-bg-active: @button-danger-bg;
...
@button-success-contained-bg-hover: @base-inverted-bg;
@button-success-contained-bg-focused: @base-inverted-bg;
@button-success-contained-bg-active: @button-success-bg;

@button-success-outlined-bg-hover: @base-inverted-bg;
@button-success-outlined-bg-focused: @base-inverted-bg;
@button-success-outlined-bg-active: @button-success-bg;

@button-success-text-bg-hover: @base-inverted-bg;
@button-success-text-bg-focused: @base-inverted-bg;
@button-success-text-bg-active: @button-success-bg;
...
@button-group-success-selected-bg: @base-success;

@button-group-normal-selected-color: @base-inverted-text-color;
@button-group-default-selected-color: @base-inverted-text-color;
...
@button-group-success-selected-bg-focused: @base-inverted-bg;
...
@diagram-normal-format-active-bg: @base-bg;

@diagram-default-format-active-bg: @base-default;
@diagram-danger-format-active-bg: @base-danger;
@diagram-success-format-active-bg: @base-success;
@diagram-image-icon-base-color: fade(@base-bg, 50%);
@diagram-image-icon-accent-color: fade(@base-shadow-color, 50%);
...
@htmleditor-danger-format-active-bg: @base-danger;
@htmleditor-success-format-active-bg: @base-success;
...
@htmleditor-mention-bg: #fff - @base-bg;
@htmleditor-mention-color: @base-inverted-text-color;
...
@list-item-selected-hover-bg: #3806ff;
...
@scrollable-scrollbar-active-bg: fade(@base-accent, 80%);
...
@progressbar-border-color: @base-accent;
...
@datagrid-row-selected-border-color: @datagrid-base-background-color;
@datagrid-row-selected-color: @base-inverted-text-color;
@datagrid-row-focused-color: @base-text-color;
@datagrid-row-focused-bg: @base-accent;
...
@datagrid-focused-border-color: @base-accent;
...
@datagrid-column-separator-bg: darken(@datagrid-base-background-color, 13.5%);
...
@treelist-columnchooser-item-color: @base-text-color;
@treelist-columnchooser-font-weight: normal;
@treelist-drag-header-border-color: @base-border-color;
@treelist-drag-header-shadow-color: @base-shadow-color;
@treelist-drag-header-second-shadow-color: @base-shadow-color;
@treelist-header-drag-bg: @base-bg;
@treelist-selection-bg: @base-inverted-bg;
@treelist-row-selected-border-color: @treelist-base-background-color;
@treelist-row-selected-color: @base-inverted-text-color;
@treelist-row-focused-color: @base-text-color;
@treelist-row-focused-bg: @base-accent;
@treelist-hover-bg: @base-hover-color;
@treelist-menu-icon-color: @base-icon-color;
@treelist-cell-modified-border-color: @base-text-color;

@treelist-row-removed-bg: fade(@base-success, 50%);
@treelist-row-invalid-faded-border-color: @base-invalid-faded-border-color;
@treelist-row-invalid-border-color: @base-invalid-color;
@treelist-nodata-color: @base-text-color;

@treelist-master-detail-cell-bg: @base-bg;
@treelist-search-color: @base-inverted-text-color;

@treelist-spin-icon-color: @base-icon-color;
@treelist-selection-spin-icon-color: @base-inverted-text-color;
@treelist-search-bg: @base-inverted-bg;
@treelist-row-error-color: @base-inverted-text-color;
@treelist-row-error-bg: @base-invalid-color;
@treelist-link-color: @base-link-color;
@treelist-focused-border-color: @base-accent;
@treelist-editor-bg: @treelist-base-background-color;
@treelist-drop-highlight-bg: @base-inverted-bg;
@treelist-drop-highlight-color: @base-inverted-text-color;
@treelist-columnchooser-bg: @base-bg;
@treelist-row-alternation-bg: @base-bg;
@treelist-columnchooser-item-bg: @base-bg;
@treelist-summary-color: @base-text-color;
@treelist-columnchooser-message-color: @base-text-color;
...
@treelist-columnchooser-overlay-border-radius: @base-border-radius + 2px;

@treelist-column-separator-bg: darken(@treelist-base-background-color, 13.5%);

@treelist-row-hovered-color: @base-text-color;
...
@PIVOTGRID_POSITION_INDICATOR_COLOR: @base-accent;
...
@SCHEDULER_WORKSPACE_FOCUSED_CELL_COLOR: lighten(@base-accent, 5%);
...
@menu-item-focused-bg: @base-focus-color;
...
@calendar-cell-other-color: @base-accent;
@calendar-bg: @base-bg;
...
@calendar-cell-active-bg: @base-accent;
...
@calendar-button-caption-color: @base-text-color;
...
@treeview-item-selected-hover-bg: @base-inverted-bg;
...
@form-field-mark-color: @base-accent;

// Images
@list-item-icon-toggle-delete-bg: url("data:image/png;base64,");
...
@scrollbar-button-horizontal-decrement-bg: url("data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAYAAAAMCAQAAADrXgSlAAAAKElEQVQY02P4zwCHvkjM/8jM/8jM/8jM/8hMDA6KMjQD0IxGsxTMBQDeRGk3UaVzYwAAAABJRU5ErkJggg==") no-repeat;
@scrollbar-button-horizontal-increment-bg: url("data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAYAAAAMCAQAAADrXgSlAAAALUlEQVQY02P47/ufAQYZ/v9HcEEcOBfCgXJhHDAXwQFycXB8sRrgi9VSJOcAAGnHaTdeddFHAAAAAElFTkSuQmCC") no-repeat;
@scrollbar-button-vertical-decrement-bg: url("data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAwAAAAGCAQAAABd57cKAAAAJklEQVQYV2P4zwCHvkAI5yELgwBcClUYSQpdGC6FKQyVwiYMAr4AgIVpN59AX3QAAAAASUVORK5CYII=") no-repeat;
@scrollbar-button-vertical-increment-bg: url("data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAwAAAAGCAQAAABd57cKAAAALklEQVQY023JwQ0AIAzDQC+Y/ccxDxQVieYXH8ZtQRaK4E+Rwku5pVBK/wBmshxQGGk3RbNhywAAAABJRU5ErkJggg==") no-repeat;
@colorbox-preview-empty-bg: url("data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABEAAAARCAQAAACRZI9xAAAAb0lEQVQoU4XOAQrAIAgFUE+2Qd1pt9rJdghnOee3jBQR5KESb4OkHj6kZ1n5VnIuUJV5UUIpUkBGZmQASEQOAnGEYCCKrgAmQgJYCicDaSfalnNF7Id2zhGQAj8g+gmCiD4yAkSdZMBRJzkw1MkmXtMsiBZyxb08AAAAAElFTkSuQmCC");
...
@filterbuilder-plus-icon-color: #008709;
@filterbuilder-plus-icon-hover-color: @filterbuilder-plus-icon-color;
@filterbuilder-plus-icon-focus-color: @filterbuilder-plus-icon-color;
@filterbuilder-remove-icon-color: #cf00d7;
@filterbuilder-remove-icon-hover-color: @filterbuilder-remove-icon-color;
@filterbuilder-remove-icon-focus-color: @filterbuilder-remove-icon-color;
@filterbuilder-group-operation-color: #cf00d7;
@filterbuilder-group-operation-hover-color: @filterbuilder-group-operation-color;
@filterbuilder-group-operation-focus-color: @filterbuilder-group-operation-color;
@filterbuilder-item-field-color: #3806ff;
@filterbuilder-item-field-hover-color: @filterbuilder-item-field-color;
@filterbuilder-item-field-focus-color: @filterbuilder-item-field-color;
@filterbuilder-item-operator-color: #008709;
@filterbuilder-item-operator-hover-color: @filterbuilder-item-operator-color;
@filterbuilder-item-operator-focus-color: @filterbuilder-item-operator-color;

@filterbuilder-item-value-color: transparent;
@filterbuilder-item-value-hover-color: @filterbuilder-item-value-color;
@filterbuilder-item-value-focus-color: @filterbuilder-item-value-color;
@filterbuilder-text-color: @base-text-color;
@filterbuilder-text-focus-color: @base-text-color;
...
@filemanager-dirs-tree-item-focus-bg: @base-text-color;
@filemanager-dirs-tree-item-focus-color: @base-bg;
...
@filemanager-file-item-select-color: @base-inverted-text-color;
@filemanager-file-item-select-bg: @base-inverted-bg;
@filemanager-progressbox-shadow-color: @base-shadow-color;

// SpeedDialAction
@speed-dial-action-bg: @base-text-color;
@speed-dial-action-hover-bg: @base-accent;
@speed-dial-action-active-bg: @base-text-color;
@speed-dial-action-color: @base-bg;
@speed-dial-action-shadow: 0 6px 12px rgba(0, 0, 0, 0.2);
@speed-dial-action-label-shadow:  0 1px 4px rgba(0, 0, 0, 0.2);
@speed-dial-action-shading-color: @base-bg;
...
@splitter-bg: darken(@base-bg, 13.5%);
