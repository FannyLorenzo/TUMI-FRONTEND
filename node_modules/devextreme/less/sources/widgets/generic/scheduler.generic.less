/**
* DevExtreme (widgets/generic/scheduler.generic.less)
* Version: 19.2.12
...
@import (once) "./recurrenceEditor.generic.less";

.dx-size-default() {
    @GENERIC_SCHEDULER_WORKSPACE_DATE_TABLE_CELL_HEIGHT: 50px;
    @GENERIC_SCHEDULER_TIMELINE_DATE_TABLE_CELL_HEIGHT: 75px;
    ...
    @GENERIC_SCHEDULER_APPOINTMENT_CONTENT_PADDING: 5px 7px;
    @GENERIC_SCHEDULER_APPOINTMENT_RECURRENCE_CONTENT_PADDING: 5px 25px 5px 7px;
    @GENERIC_SCHEDULER_APPOINTMENT_RECURRENCE_CONTENT_PADDING_RTL: 5px 7px 5px 25px;
    ...
    @GENERIC_SCHEDULER_APPOINTMENT_TRANSPARENT_LEFT_BORDER: 3px solid transparent;
    @GENERIC_SCHEDULER_APPOINTMENT_TRANSPARENT_RIGHT_BORDER: 2px solid transparent;

    @SCHEDULER_RECURRENCE_EDITOR_ITEM_OFFSET: -88px;
    @SCHEDULER_RECURRENCE_REPEAT_LABEL_OFFSET: 5px;

    @GENERIC_SCHEDULER_APPOINTMENT_COLLECTOR_HEIGHT: 20px;
}

.dx-size-compact() {
    @GENERIC_SCHEDULER_WORKSPACE_DATE_TABLE_CELL_HEIGHT: 36px;
    @GENERIC_SCHEDULER_TIMELINE_DATE_TABLE_CELL_HEIGHT: 50px;
    ...
    @GENERIC_SCHEDULER_WORKSPACE_INFO_TEXT_SIZE: 14px;
    @GENERIC_SCHEDULER_ALL_DAY_TITLE_FONT_SIZE: 11px;

    @GENERIC_SCHEDULER_APPOINTMENT_CONTENT_PADDING: 2px 5px;
    @GENERIC_SCHEDULER_APPOINTMENT_RECURRENCE_CONTENT_PADDING: 2px 25px 2px 5px;
    @GENERIC_SCHEDULER_APPOINTMENT_RECURRENCE_CONTENT_PADDING_RTL: 2px 5px 2px 25px;
    ...
    @GENERIC_SCHEDULER_APPOINTMENT_TRANSPARENT_LEFT_BORDER: 2px solid transparent;
    @GENERIC_SCHEDULER_APPOINTMENT_TRANSPARENT_RIGHT_BORDER: 1px solid transparent;

    @SCHEDULER_RECURRENCE_EDITOR_ITEM_OFFSET: -80px;
    @SCHEDULER_RECURRENCE_REPEAT_LABEL_OFFSET: 3px;

    @GENERIC_SCHEDULER_APPOINTMENT_COLLECTOR_HEIGHT: 17px;
}

@GENERIC_SCHEDULER_APPOINTMENT_REDUCED_CONTENT_PADDING: 40px;
@GENERIC_SCHEDULER_APPOINTMENT_EMPTY_TRANSPARENT_BORDER: 1px solid transparent;
...
@GENERIC_SCHEDULER_CURRENT_TIME_CELL_BORDER_SIZE: 2px;
...
.dx-scheduler-work-space-vertical-grouped {
    .dx-scheduler-header-panel {
        margin-top: @GENERIC_SCHEDULER_HEADER_PANEL_TOP_GAP + 1px;
    }
}
...
.dx-scheduler-header-panel-cell {
    ...
    &.dx-scheduler-header-panel-current-time-cell {
        &:before {
            top: @GENERIC_SCHEDULER_HEADER_PANEL_TABLE_CELL_HEIGHT - @GENERIC_SCHEDULER_CURRENT_TIME_CELL_BORDER_SIZE - 1;
            height: @GENERIC_SCHEDULER_CURRENT_TIME_CELL_BORDER_SIZE;
        }
    }
}
...
.dx-scheduler-timeline {
    .dx-scheduler-date-table-cell {
        height: @GENERIC_SCHEDULER_TIMELINE_DATE_TABLE_CELL_HEIGHT;
    }
}
...
.dx-scheduler-work-space-grouped.dx-scheduler-agenda,
...
.dx-scheduler-appointment-collector {
    height: @GENERIC_SCHEDULER_APPOINTMENT_COLLECTOR_HEIGHT;

    .dx-scheduler-appointment-collector-content {
        span:last-child {
            line-height: @GENERIC_SCHEDULER_APPOINTMENT_COLLECTOR_HEIGHT / 1.5;
            height: @GENERIC_SCHEDULER_APPOINTMENT_COLLECTOR_HEIGHT;
        }
    }
    ...
    &.dx-state-hover {
        &:before {
            border-radius: @GENERIC_SCHEDULER_APPOINTMENT_COLLECTOR_HEIGHT;
        }
    }
...
.dx-scheduler-appointment {
    border-left: @GENERIC_SCHEDULER_APPOINTMENT_TRANSPARENT_LEFT_BORDER;
    border-right: @GENERIC_SCHEDULER_APPOINTMENT_TRANSPARENT_RIGHT_BORDER;
    ...
    &.dx-scheduler-appointment-empty {
        border-left: @GENERIC_SCHEDULER_APPOINTMENT_EMPTY_TRANSPARENT_BORDER;
        border-right: @GENERIC_SCHEDULER_APPOINTMENT_EMPTY_TRANSPARENT_BORDER;
    }
}

.dx-scheduler-appointment-content {
    padding: @GENERIC_SCHEDULER_APPOINTMENT_CONTENT_PADDING;
}

.dx-scheduler-appointment-reduced {
    .dx-scheduler-appointment-content {
        padding-right: @GENERIC_SCHEDULER_APPOINTMENT_REDUCED_CONTENT_PADDING;
    }
}

.dx-scheduler-appointment-recurrence {
    .dx-scheduler-appointment-content {
        padding: @GENERIC_SCHEDULER_APPOINTMENT_RECURRENCE_CONTENT_PADDING;

        .dx-rtl & {
            padding: @GENERIC_SCHEDULER_APPOINTMENT_RECURRENCE_CONTENT_PADDING_RTL;
        }
    }
}
    ...
    &.dx-scheduler-work-space.dx-scheduler-work-space-all-day {
        ...
        &:not(.dx-scheduler-work-space-vertical-grouped) {
            ...
            &.dx-scheduler-work-space-day {
                ...
                &:not(.dx-scheduler-work-space-grouped) {
                    .dx-scheduler-header-scrollable-mixin(@GENERIC_SCHEDULER_ALL_DAY_TABLE_CELL_HEIGHT);

                    &.dx-scheduler-work-space-all-day-collapsed {
                        .dx-scheduler-header-scrollable-mixin(@GENERIC_SCHEDULER_COLLAPSED_ALL_DAY_TABLE_CELL_HEIGHT);
                    }
                }
            }
        }
...
.dx-scheduler-agenda {
    ...
    &.dx-scheduler-work-space {
        .dx-scheduler-scrollable-offset-mixin(0, 0, 0);
    }
