/**
* DevExtreme (widgets/ios7/lookup.ios7.less)
* Version: 19.2.12
...
.dx-rtl {
    ...
    .dx-validation-pending.dx-lookup,
    &.dx-validation-pending.dx-lookup {
...
.dx-lookup-popup-wrapper > .dx-rtl {
    .dx-list-item {
        &:before {
            float: left;
        }

        &.dx-list-item-selected .dx-list-item-content:before {
            float: left;
