/**
* DevExtreme (widgets/ios7/dateBox.ios7.less)
* Version: 19.2.12
...
*/
@import (once) "./timeView.ios7.less";
@import (once) "./dateView.ios7.less";
...
.dx-datebox {
    ...
    &.dx-dropdowneditor-field-clickable .dx-dropdowneditor-button {
        display: none;
    }
