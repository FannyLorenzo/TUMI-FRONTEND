/**
* DevExtreme (widgets/common/scheduler.less)
* Version: 19.2.12
...
@import (once) "./recurrenceEditor.less";
...
.dx-scheduler {
    ...
    .dx-scheduler-work-space-month > .dx-scrollable-native {
        .dx-scrollable-content {
            // min-height is need to rewrite the original .dx-scrollable-content that have magic min-height: 101%.
            // 101% is need to fix the bounds on ios devices.
            min-height: 100%;
            height: 100%;
        }
    }
