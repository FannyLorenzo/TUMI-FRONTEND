/**
* DevExtreme (widgets/common/gridBase.less)
* Version: 19.2.12
...
.grid-base(@widgetName) {
    ...
    .dx-@{widgetName} {
        ...
        .dx-@{widgetName}-rowsview .dx-data-row .dx-command-drag {
            cursor: move;
            vertical-align: middle;
            padding: 0;
        }
    ...
    .dx-sortable-dragging .dx-@{widgetName}-rowsview .dx-data-row .dx-command-drag {
        cursor: pointer;
        cursor: grabbing;
    }
    ...
    .dx-@{widgetName}-rowsview {
        ...
        .dx-@{widgetName}-table .dx-row.dx-freespace-row,
        .dx-@{widgetName}-table .dx-row.dx-virtual-row {
            border-top: 0;
            border-bottom: 0;
    ...
    // ie11
    .dx-@{widgetName} .dx-row .dx-@{widgetName}-hidden-column {
