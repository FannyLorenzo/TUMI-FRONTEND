            ...
            return {
                ...
                updateColumns: function(dataSource, forceApplying) {
                    ...
                    if (!dataSource || dataSource.isLoaded()) {
                        var sortParameters = dataSource ? dataSource.sort() || [] : that.getSortDataSourceParameters();
                        var groupParameters = dataSource ? dataSource.group() || [] : that.getGroupDataSourceParameters();
                            ...
                            update: function() {
                                ...
                                if (dataSource) {
                                    ...
                                    if ((0, _type.isPlainObject)(dataSource) || dataSource instanceof _abstract_store2.default || Array.isArray(dataSource)) {
                                        if (that.valueExpr) {
                                            var dataSourceOptions = (0, _data_source.normalizeDataSourceOptions)(dataSource);
                ...
                getRowIndex: function(columnIndex, alwaysGetRowIndex) {
                    ...
                    return column && (alwaysGetRowIndex || column.visible && !(column.command || (0,
                        _type.isDefined)(column.groupIndex))) ? getParentBandColumns(columnIndex, bandColumnsCache.columnParentByIndex).length : 0
                },
