...
(0, _uiListEdit.register)("reorder", "default", _uiListEdit3.default.inherit({
    ...
    _dragTemplate: function(e) {
        return (0, _renderer2.default)(e.itemElement).clone().width((0, _renderer2.default)(e.itemElement).width()).addClass(REORDERING_ITEM_GHOST_CLASS).addClass(STATE_HOVER_CLASS).toggleClass("dx-rtl", this.option("rtlEnabled"))
    },
