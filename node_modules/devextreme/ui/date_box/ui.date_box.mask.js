...
var DateBoxMask = _uiDate_box2.default.inherit({
    ...
    _keyboardHandler: function(e) {
        ...
        if (_browser2.default.chrome && "Process" === e.key && 0 === e.code.indexOf("Digit")) {
    ...
    _attachMaskEvents: function() {
        ...
        _events_engine2.default.on(this._input(), (0, _utils.addNamespace)("compositionend", MASK_EVENT_NAMESPACE), this._maskCompositionEndHandler.bind(this));
    ...
    _maskCompositionEndHandler: function(e) {
        var _this5 = this;
        if (_browser2.default.msie && this._isSingleDigitKey(e)) {
            var key = e.originalEvent.data;
            this._processInputKey(key)
        } else {
