...
var PushStrategy = function(_DrawerStrategy) {
    ...
    _createClass(PushStrategy, [{
        ...
        value: function(changePositionUsingFxAnimation, whenAnimationCompleted) {
            ...
            (0, _renderer2.default)(drawer.content()).css(drawer.isHorizontalDirection() ? "width" : "height", openedPanelSize);
            if (drawer.getMinSize()) {
                ...
                }(0, _renderer2.default)(drawer.viewContent()).css(paddingCssPropertyName, drawer.getMinSize())
            } else {}
            if (changePositionUsingFxAnimation) {
                _uiDrawerRendering.animation.moveTo({
                    $element: (0, _renderer2.default)(drawer.viewContent()),
                ...
                if (drawer.isHorizontalDirection()) {
                    _translator2.default.move((0, _renderer2.default)(drawer.viewContent()), {
        ...
        value: function() {
            (0, _renderer2.default)(this.getDrawerInstance().viewContent()).addClass("dx-theme-background-color")
        }
    }]);
    return PushStrategy
