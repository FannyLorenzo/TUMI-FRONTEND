...
var DrawerStrategy = function() {
    ...
    _createClass(DrawerStrategy, [{
        ...
        key: "renderPosition",
        value: function(changePositionUsingFxAnimation, animationDuration) {
            var whenPositionAnimationCompleted = new _deferred.Deferred;
            var whenShaderAnimationCompleted = new _deferred.Deferred;
            var drawer = this.getDrawerInstance();
            if (changePositionUsingFxAnimation) {
                _deferred.when.apply(_renderer2.default, [whenPositionAnimationCompleted, whenShaderAnimationCompleted]).done(function() {
        ...
        value: function(changePositionUsingFxAnimation, duration, whenAnimationCompleted) {
            var _this = this;
            var drawer = this.getDrawerInstance();
