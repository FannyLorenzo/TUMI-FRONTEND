...
var Drawer = _ui2.default.inherit({
    ...
    _initTemplates: function() {
        this.callBase();
        this._defaultTemplates[PANEL_TEMPLATE_NAME] = new _empty_template.EmptyTemplate;
    ...
    _renderPosition: function(isDrawerOpened, disableAnimation, jumpToEnd) {
        ...
        (0, _renderer2.default)(this.viewContent()).css("paddingRight", 0);
        (0, _renderer2.default)(this.viewContent()).css("paddingTop", 0);
        (0, _renderer2.default)(this.viewContent()).css("paddingBottom", 0);
    ...
    _refreshPanel: function() {
        ...
        (0, _renderer2.default)(this.viewContent()).removeClass("dx-theme-background-color");
