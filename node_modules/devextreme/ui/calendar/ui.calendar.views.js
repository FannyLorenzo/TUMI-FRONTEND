...
var Views = {
    ...
    year: _uiCalendar2.default.inherit({
        ...
        _getFirstCellData: function() {
            ...
            var data = (0, _date.createDate)(currentDate);
            data.setDate(1);
            data.setMonth(0);
            return data
        },
        ...
        _getCellByDate: function(date) {
            var foundDate = (0, _date.createDate)(date);
            foundDate.setDate(1);
    ...
    decade: _uiCalendar2.default.inherit({
        ...
        _isOtherView: function(cellDate) {
            var date = (0, _date.createDate)(cellDate);
            date.setMonth(1);
        ...
        _getFirstCellData: function() {
            ...
            return (0, _date.createDateWithFullYear)(year, 0, 1)
        },
        _getNextCellData: function(date) {
            date = (0, _date.createDate)(date);
        ...
        getNavigatorCaption: function() {
            ...
            var startDate = (0, _date.createDate)(currentDate);
            var endDate = (0, _date.createDate)(currentDate);
