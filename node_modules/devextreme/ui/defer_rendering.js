...
var _transition_executor2 = _interopRequireDefault(_transition_executor);
...
var DeferRendering = _ui2.default.inherit({
    ...
    _init: function() {
        this.transitionExecutor = new _transition_executor2.default.TransitionExecutor;
        this._initElement();
        this._initRender();
    ...
    _initRender: function() {
        ...
        if ((0, _type.isPromise)(renderWhen)) {
            _deferred2.default.fromPromise(renderWhen).done(doRender)
        } else {
    ...
    _initActions: function() {
        ...
        (0, _iterator.each)(ACTIONS, function(_, action) {
            this._actions[action] = this._createActionByOption(action) || _common2.default.noop
        }.bind(this))
    },
    ...
    _renderDeferredContent: function() {
        ...
        this._renderTask = _common2.default.executeAsync(function() {
    ...
    _isElementInViewport: function(element) {
        ...
        return rect.bottom >= 0 && rect.right >= 0 && rect.top <= (window.innerHeight || _dom_adapter2.default.getDocumentElement().clientHeight) && rect.left <= (window.innerWidth || _dom_adapter2.default.getDocumentElement().clientWidth)
    },
    _animate: function() {
        var that = this;
        var $element = this.$element();
        var animation = _window2.default.hasWindow() && this.option("animation");
            ...
            if (staggerItemSelector) {
                $element.find(staggerItemSelector).each(function() {
                    if (that._isElementInViewport(this)) {
                        that.transitionExecutor.enter((0, _renderer2.default)(this), animation)
                    }
                })
            } else {
    ...
    _renderImpl: function() {
        ...
        _events_engine2.default.trigger($element, "dxcontentrendered");
    ...
    _showLoadIndicator: function($container) {
        this._$loadIndicator = new _load_indicator2.default((0, _renderer2.default)("<div>"), {
            visible: true
        }).$element().addClass(DEFER_DEFER_RENDERING_LOAD_INDICATOR);
        (0, _renderer2.default)("<div>").addClass(LOADINDICATOR_CONTAINER_CLASS).addClass(DEFER_RENDERING_LOADINDICATOR_CONTAINER_CLASS).append(this._$loadIndicator).appendTo($container)
    },
    _setRenderedState: function() {
        ...
        _dom2.default.triggerShownEvent($element.children())
    },
...
(0, _component_registrator2.default)("dxDeferRendering", DeferRendering);
