...
declare const DxPolarChart: VueType.VueConstructor<{
    instance: PolarChart;
} & {
    adaptiveLayout: any;
    animation: any;
    ...
    onArgumentAxisClick: TimerHandler;
