...
declare const DxLookup: VueType.VueConstructor<{
    ...
    pageLoadMode: string;
    placeholder: string;
    popupHeight: string | number | Function;
    popupWidth: string | number | Function;
    position: any;
